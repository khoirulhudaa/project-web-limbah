...
<label><font size="5"><u><center>Laporan Data Barang Pengemasan</center></u></font></label>
...
<table style="border: 1px solid gray;" width="100%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<th style="border-right: 1px solid gray">Id pengemasan</th>
	...
	<?php
		include"config.php";
		$no=1;
		$sqls = mysqli_query($conn,"Select * from tbl_pengemasan");
		...
		<tr>
			...
			<td align="center" style="border-right: 1px solid gray; border-top: 1px solid gray; padding: 3px 5px;" ><?php echo"$rs[id_pengemasan]"; ?></td>
