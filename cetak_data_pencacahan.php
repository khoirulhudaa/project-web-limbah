...
<table style="border: 1px solid gray;" width="100%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<th style="border-right: 1px solid gray">Id pencacahan</th>
	...
	<?php
		include"config.php";
		$no=1;
		$sqls = mysqli_query($conn,"Select * from tbl_pencacahan");
		...
		<tr>
			...
			<td align="center" style="border-right: 1px solid gray; border-top: 1px solid gray; padding: 3px 5px;" ><?php echo"$rs[id_pencacahan]"; ?></td>
