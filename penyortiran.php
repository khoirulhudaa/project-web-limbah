        ...
        if($_POST['kd_plastik'] == "") {
            ...
            if($sql2) {
              echo '<script>setTimeout(function(){ location.reload(); }, 100);</script>';  echo '<script>
                      setTimeout(function() {
                          window.location.href = "?page=penyortiran";
                      }, 100);
                    </script>';
              $conn->close();
              exit;
...
<body class="home">
 ...
 <aside id="sidebar" class="sidebar">
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Data Penyortiran</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item"><a href="index.php">Kelola produksi</a></li>
          <li class="breadcrumb-item active">Kelola Penyortiran</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="card-body">
              ...
              <hr>
                    <!-- Button trigger modal -->
                      ...
                      <a href="cetak_data_penyortiran.php" target="_blank" class="btn btn-outline-info mb-3">
                        Print</a>
              ...
              <table class="table table-bordered">
                <thead>
                  <tr>
                    <th scope="col">No.</th>
                    <th scope="col">Id penyortiran</th>
                ...
                <?php
                  $no=1;
                      if (isset($_GET['search'])) {
                        ...
                        $sql = "SELECT * FROM tbl_penyortiran WHERE nama_brg LIKE '%$search_keyword%'";
                        $sqls = mysqli_query($conn, $sql);
                      } else {
                        $sql = "SELECT * FROM tbl_penyortiran";
                        $sqls = mysqli_query($conn, $sql);
                    }
                  ...
                  <tr>
                  <td><?php echo"$no"; ?></td>
                    <td><?php echo"$rs[id_penyortiran]"; ?></td>
                    ...
                    <td class="d-flex justify-content-center">
                      <!-- Button trigger modal -->
                    <button type="button" class="btn btn-outline-success mb-2" data-bs-toggle="modal" data-bs-target="#ModalEdit<?php echo $rs['id_penyortiran']; ?>"><i class="bi bi-arrow-right"></i></button>
                     <!-- Modal Edit -->
                       <form method="POST" action="">
                          <div class="modal fade" id="ModalEdit<?php echo $rs['id_penyortiran']; ?>" tabindex="-1" aria-labelledby="ModalEdit" aria-hidden="true">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                      <label for="kd_plastik" class="form-label">Id penyortiran</label>
                                      <input type="text" class="form-control" name="id_penyortiran" value="<?php echo"$rs[id_penyortiran]"?>">
                                    </div>
                                    <div class="mb-3">
                                      <label for="kd_plastik" class="form-label">Kode plastik</label>
                                ...
                                <div class="modal-footer">
                                  <input type="hidden" name="id_penyortiran" class="form-control" value="<?php echo"$rs[id_penyortiran]" ?>">
                                  <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    ...
                    if (isset($_POST['produksi'])) {
                      $id_penyortiran = $_POST['id_penyortiran'];
                      ...
                      $id_pencacahan = generateRandomString(5);
                      ...
                      if ($_POST['kode_brg2'] == "") {
                        ...
                        $sql = "INSERT INTO tbl_pencacahan (id_pencacahan, kode_brg, jum_sortir, nama_brg) VALUES ('$id_pencacahan', '$kd_plastik', '$jum_sortir', '$nama_brg')";
                        $sql2 = mysqli_query($conn, $sql);
                        if ($sql2) {
                          $sqldelete = "DELETE FROM tbl_penyortiran WHERE id_penyortiran = '$id_penyortiran'";
                    ...
                    ?>
                    <!-- End Modal Edit -->
                  <a href ="?page=barang&hapus=<?php echo $rs['id_penyortiran']; ?>" class="btn btn-outline-danger" style="height: 38px;margin: 0 10px;" name="hapus"><i class="bi bi-trash"></i></a>
                  <?php
                   if (isset($_GET['hapus'])) {
                       $id_penyortiran = $_GET['hapus'];
                       if (!empty($id_penyortiran)) {
                      $sqlhapus = "DELETE FROM tbl_penyortiran WHERE id_penyortiran='$id_penyortiran'";
